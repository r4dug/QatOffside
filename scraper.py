...
misc2 = ["cards_yellow","cards_red","cards_yellow_red","fouls","fouled","offsides","crosses","interceptions","tackles_won","pens_won","pens_conceded"]
...
df_outfield = get_outfield_data('https://fbref.com/en/comps/1/','/World-Cup-Stats')
